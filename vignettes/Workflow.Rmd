...
<<<<<<< HEAD
Statistical analysis will then be performed, including pairwise comparisons between the groups. The parameter `sample_relationship` allows users to specify whether the group variables should be analyzed as independent or paired. By default, it is set to Independent, and to run as Paired, the user must provide groups with the same number of samples, with the order of the samples across them remaining the same.
=======
...
>>>>>>> f64da3ebec4d622b634e00a6c75f68c08ee7318f
