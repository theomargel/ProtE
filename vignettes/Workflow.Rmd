...
## Seting up group names and number of samples per group
 Regarding the parameters `group_names` and `samples_per_group`, the user must provide these parameters inside a vector, in the order they appear inside the Excel matrix:
