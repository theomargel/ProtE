...
pd_multi (excel_file = "C:\\Bioprojects\\BreastCancer\\Proteomics\\PD\\Control",
                    ...
                    significance = "pV")
```
In the pairwise comparisons, nominators and denominators of the FoldChange (and consequently the sign of Log2FoldChage) are defined based on the order of the group folders written in .... Again, the general notion based on which FoldChange is determined in this case is: NextGroup/PreviousGroup. In our example the FoldChange for every pairwise comparison will be set as: Treatment/Control, Compound/Control and Compound/Treatment.
