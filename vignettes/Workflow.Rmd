...
knitr::include_graphics(system.file("docs/images", "sdmeanplot.jpeg", package = "ProtE"))
```
...
knitr::include_graphics(system.file("docs/images", "imputation_histogram.jpeg", package = "ProtE"))
```
...
knitr::include_graphics(system.file("docs/images", "prabrank.jpg", package = "ProtE"))
```
...
knitr::include_graphics(system.file("docs/images", "Boxplot.jpeg", package = "ProtE"))
```
...
knitr::include_graphics(system.file("docs/images", "ViolinPlot.jpeg", package = "ProtE"))
```
...
knitr::include_graphics(system.file("docs/images", "pcaplotall.jpeg", package = "ProtE"))
```
...
knitr::include_graphics(system.file("docs/images", "pcaplotsig.jpeg", package = "ProtE"))
```
...
knitr::include_graphics(system.file("docs/images", "heatmap.jpeg", package = "ProtE"))
```
