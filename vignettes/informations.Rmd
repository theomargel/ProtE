...
One function to analyze them all! The Proteomics Eye (ProtE) establishes univariate analysis of label-free proteomics data generated from three different software platforms: MaxQuant, DIA-NN and Proteome Discoverer. By automating data wrangling and processing steps into the same function, ProtE performs all pairwise statistical comparisons for a given categorical variable, returning to the user  metrics for evaluating the proteomics output
