...
\[6\] Wulff, J.E., Mitchell, M.W., A Comparison of Various Normalization
Methods for LC/MS Metabolomics Data. *Advances in Bioscience and
Biotechnology* 2018, 09, 339–351.
...
\[10\] Kowarik, A., Templ, M., Imputation with the *R* Package **VIM**.
*J Stat Softw* 2016, 74.
...
\[13\] Hutchings, C., Dawson, C.S., Krueger, T., Lilley, K.S., Breckels,
L.M., A Bioconductor workflow for processing, evaluating, and
interpreting expression proteomics data. *F1000Res* 2023, 12, 1402.
