...
and Proteome Discoverer. [ProtE- CRAN:
Manual](https://cran.r-project.org/web/packages/ProtE/ProtE.pdf) \## How
to install: If you already have R Studio and Rtools in your PC skip to
Step 4.
