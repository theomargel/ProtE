...
writeLines(c("ProtE Parameter Report",
             ...
             "",
             paste("Normalization method:", normalization),
             paste("Filtering: Minimum percentage (%) of NON-Missing Values of a protein=", filtering_value),
             ifelse(global_filtering == TRUE, paste("Filtering Percentage set in all samples of the dataset"), paste("Filtering Percentage set inside the provided groups")),
             paste("Imputation method:", imputation),
