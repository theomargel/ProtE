...
dataspace <- dataspace[,-c(1,4:8)]
dataspace <- dataspace[,c(1:(2+sum(case_number)))]
...
colnames(dataspace) <- gsub("Abundance:.", "", colnames(dataspace))
colnames(dataspace) <- gsub(":.Sample", "", colnames(dataspace))
